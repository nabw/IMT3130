"""
Illustrates the difference between standard vector Laplacian and symmetric gradient (strain-rate tensor) formulations under Dirichlet boundary conditions.
"""
