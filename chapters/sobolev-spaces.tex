...
A distribution is a continuous linear functional on $\mathcal D(\Omega)$. The space of all distributions is denoted by $\mathcal D'(\Omega)$. Continuity means that if $\phi_k\to\phi$ in $\mathcal D(\Omega)$ then $\langle T,\phi_k\rangle\to\langle T,\phi\rangle$ in $\mathbb R$ (or $\mathbb C$). We write the action of $T$ on a test function $\phi$ as $\langle T,\phi\rangle$.
\end{definition}
