...
\end{theorem}
    \begin{proof}
       ...
       \end{tightalign*}
       By hypothesis, as the integral of any measurable subset is zero, the entire right hand-side is zero. As the integral of $|f|$ over $\Omega$ is zero, this imples that $|f|=0$ a.e in $\Omega$. So $f=0$ a.e. in $\Omega$.
    \end{proof}
