...
\newcommand{\example}[1]{ \begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black!70!white,title=Example]#1 \end{tcolorbox}}
...
\NewEnviron{tightalign*}{%
  \setlength{\abovedisplayskip}{\tightTOP}%
  \setlength{\belowdisplayskip}{\tightBOTTOM}%
  \setlength{\abovedisplayshortskip}{\tightLEFT}%
  \setlength{\belowdisplayshortskip}{\tightRIGHT}%
  \begin{align*}
