...
\paragraph{\textbf{Flexibilities.}} All projects will be assumed to be developed in high level software such as Firedrake, NGSolve, Gridap, FEniCS or others, so that the implementation of a FEM code is not part of the difficulty. Still, flexilibity with respect to the stated goals will be considered for projects if you want to explore different topics, such as: 
\begin{itemize}
