...
\begin{enumerate}
    ...
    \item\pts{2} Enuncie y demuestre la regla de la cadena para derivadas de Fréchet, dada por $d(G\circ F)(u)[h] = dG(F(u))[dF(u)[h]$. Luego, úsela para encontrar la derivada de la composición $S\circ T$ de los operadores $S:L^\infty(\Omega)\to L^\infty(\Omega)$ y $T:L^\infty(\Omega)\to L^\infty(\Omega)$ dados por $S(u) = \sin u$ y $T(u) = \cos u$. Defina de manera precisa todos los espacios usados para generar usar la regla de la cadena. 
