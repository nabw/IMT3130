...
\begin{frame}{Step 1: Bdd Below $\iff$ Injective + Closed Range}
    \begin{block}{Lemma 1}
...
\begin{frame}[t]{Step 3: Characterizing Injectivity}
    \begin{block}{Lemma}
...
\begin{frame}{Example: The Transport Equation}
    ...
    \end{align*}
    Thus $\sup_{v} a(u,v)/\|v\|_{L^2} \ge a(u, u'+u)/\|u'+u\|_{L^2} \ge \alpha \|u\|_{H^1}$. Well-posed!
\end{frame}
...
\begin{frame}{Céa's Estimate via Discrete Inf-Sup}
    ...
    \begin{align*}
        \|u_h - u_h\|_U &\le \frac{1}{\alpha_h} \sup_{v_h \in V_h} \frac{a(u_h - u_h, v_h)}{\|v_h\|_V} \tag{Discrete Inf-Sup} \\
        &= \frac{1}{\alpha_h} \sup_{v_h \in V_h} \frac{a(u - w_h, v_h)}{\|v_h\|_V} \tag{Galerkin Orthog. $a(u-u_h, v_h)=0$} \\
        &\le \frac{M}{\alpha_h} \|u - w_h\|_U \tag{Continuity of $a(\cdot,\cdot)$}
    \end{align*}
    \qed
\end{frame}
